const steps = [
  {
    num: '01',
    title: 'Connect',
    desc: 'We connect to your existing cameras and sensors (gas, temperature, pressure, smoke) using your current infrastructure. No construction. 5 minutes per camera.',
  },
  {
    num: '02',
    title: 'Go Live',
    desc: 'Your plant floor appears as a live map on the AdvanceSafe dashboard. Every zone shows a live safety score. Your team gets real-time alerts via Push, SMS, and WhatsApp through mobile app.',
  },
  {
    num: '03',
  ...
  return (
    <section id="how-it-works" className="reveal" aria-labelledby="how-title">
      <div className="container">
        <h2 className="section-title" id="how-title">Up and Running in 2 to 3 Days.</h2>
        <div className="steps">
          {steps.map((s) => (
