...
export default function App() {
  ...
  useEffect(() => {
    document.title = 'AdvanceSafe — AI Factory Safety & PPE Detection India';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute(
        'content',
        'AI industrial safety software India: factory safety monitoring, PPE detection AI, worker safety system & smart surveillance. Book a demo.'
      );
    }
  }, []);
