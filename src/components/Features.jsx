  ...
  return (
    <section id="features" className="reveal" aria-labelledby="features-title">
      <div className="container">
        <h2 className="section-title" id="features-title">Factory safety monitoring, PPE AI, and automation in one stack</h2>
        <p className="hero__sub" style={{ marginTop: '-2rem', marginBottom: '2rem', maxWidth: '72ch' }}>
          AdvanceSafe combines <strong>smart industrial surveillance</strong> with workflows your HSE team already understands — so{' '}
          <strong>workplace safety automation</strong> shows up as faster escalations, clearer accountability, and audit-ready history.
        </p>
